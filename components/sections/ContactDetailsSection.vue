...
<template>
  <div class="contact-details-wrap">
      ...
      <div class="row g-4 justify-content-center">
        ...
        <div class="col-12 col-md-6 col-lg-4">
          <div class="contact-info-card">
            ...
            <h4>info@tarasolutions-cr.com</h4>
          </div>
        </div>
        ...
        <div class="col-12 col-md-6 col-lg-4">
          <div class="contact-info-card">
            ...
            <h4>Costa Rica, San Jose, Barrio Amón, Ave 13, Calle 7</h4>
          </div>
        </div>
      </div>
    </div>
   ...
   <div class="maps-wrap">
  <iframe
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3930.010619795501!2d-84.07818772425492!3d9.938870990158803!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8fa0e33cdbfd13b9%3A0x7f8a63c9d3e50ff7!2sBarrio%20Am%C3%B3n%2C%20Ave%2013%2C%20Calle%207%2C%20San%20Jos%C3%A9%2C%20Costa%20Rica!5e0!3m2!1sen!2sbd!4v1730050000000!5m2!1sen!2sbd"
    width="100%"
    height="400"
    style="border:0;"
    ...
    <!-- Contact Form -->
    <div class="contact-form-wrap contact-page-form">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-lg-10">
            <div class="contact-form bg-secondary m-0 mt-0">
            ...
            <form @submit="handleSubmit">
                <div class="row g-4 g-xl-5">
                  ...
                  <div class="col-12">
                    <textarea class="form-control" rows="6" placeholder="Type your message" required></textarea>
                  </div>
                  <div class="col-12">
              ...
              <!-- Popup message -->
              <div v-if="showMessage" class="contact-popup">
