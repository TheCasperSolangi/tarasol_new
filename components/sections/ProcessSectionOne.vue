...
<template>
  <div class="process-wrapper bg-secondary">
      ...
      <div class="row g-3 justify-content-center">
        <div class="col-12 col-lg-6">
          <div class="section-heading text-center">
            <h2 class="mb-0">Simple Our Work<br>Process</h2>
          </div>
        </div>
      </div>
      ...
      <div class="row g-4">
        ...
        <div class="col-12 col-md-6 col-lg-4">
          <div class="process-card-two">
            ...
            <p class="mb-0">Design Strateg Invole Comprehensive Approch To Ensuring That The Design Meets The
              Goals And Needs</p>
          </div>
        </div>
