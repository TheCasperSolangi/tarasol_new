...
<template>
  <div class="offcanvas offcanvas-start right-side-vorix-offcanvas shadow-lg" tabindex="-1" id="sideMenuOffcanvas">
    <!-- Offcanvas Header -->
    <div class="offcanvas-header">
      <div>
        <img class="dark-logo" src="@/assets/img/core-img/logo.png" alt="">
        <img class="light-logo" src="@/assets/img/core-img/logo-light.png" alt="">
      </div>

      <button type="button" class="btn-close btn-close-white shadow-lg" data-bs-dismiss="offcanvas"
              aria-label="Close">
      </button>
    </div>
    ...
    <div class="offcanvas-body">
      ...
      <div class="contact-info">
        ...
        <div>
          <div class="icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
              <g clip-path="url(#clip0_274_2389)">
                <path
          ...
          <div>
            <p>Phone number</p>
            <h5 class="mb-0">+44 204 577 0077</h5>
          </div>
        </div>
        ...
        <div>
          ...
          <div>
            <p>Email address</p>
            <h5 class="mb-0">Vorix@gmail.com</h5>
          </div>
        </div>
        ...
        <div>
          ...
          <div>
            <p>Office Address</p>
            <h5 class="mb-0">Washington Ave, NY </h5>
          </div>
        </div>
      </div>
      ...
      <!-- CTA Button -->
      <div class="cta-btn">
        <NuxtLink to="/contact">Let's Talk <br> with us</NuxtLink>
      </div>
    </div>
  </div>
</template>
